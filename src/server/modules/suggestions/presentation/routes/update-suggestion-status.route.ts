...
import { SUGGESTION_STATUSES } from '@/shared';
import { authMiddleware } from '../../../../lib/middlewares/auth.middleware';
import { createProjectAdminMiddleware } from '../../../../lib/middlewares/project-admin.middleware';
import { type AuthVariables } from '../../../../lib/auth';
import { UpdateSuggestionStatusUseCase } from '../../application/use-cases/update-suggestion-status.use-case';
import { suggestionSchema } from '../suggestion.schemas';
import type { IProjectMemberRepository } from '../../../projects/domain/project-member/project-member.repository';
